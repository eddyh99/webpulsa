                    ...
                    <div class="">
                        <div class="col-sm-8 col-md-9">
                            <div class="panel panel-default">
                                ...
                                <form action="https://polarispulsa.com/akun/deposit" method="post" accept-charset="utf-8">                                                               <input type="hidden" name="csrf_token" value="41fc5bed2ef3700980f61873d0afb2d2">
                                    <div class="row">
                                    ...
                                    <div class="alert alert-info fade in"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button><center><i class="fa fa-info-circle"></i> <b>CASHABCAK 0,1%  </b></center><br>Dapatkan cashback 0,1% dengan deposit minimal Rp 1.000.000 cair jam 07:00 di hari berikutnya hanya berlaku untuk metode pembayaran transfer bank</div>
                                </form>            
